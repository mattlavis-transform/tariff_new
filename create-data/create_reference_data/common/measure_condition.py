...
class measure_condition(object):
	...
	def writeXML(self):
		out = o.app.measure_condition_XML
		...
		out = out.replace("[MEASURE_CONDITION_SID]",				str(o.app.last_measure_condition_sid))
		out = out.replace("[TRANSACTION_ID]",						str(o.app.transaction_id))
		out = out.replace("[MESSAGE_ID]",							str(o.app.message_id))
		out = out.replace("[RECORD_SEQUENCE_NUMBER]",				str(o.app.message_id))
		...
		o.app.message_id 					+= 1
		o.app.last_measure_condition_sid	+= 1
