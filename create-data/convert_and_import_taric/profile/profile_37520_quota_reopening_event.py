...
class profile_37520_quota_reopening_event(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        reopening_date = app.get_date_value(omsg, ".//oub:reopening.date", True)
        ...
        if g.app.perform_taric_validation is True:
            if quota_definition_sid not in g.app.quota_definitions:
                g.app.record_business_rule_violation("QRE1", "The quota definition SID must exist.", operation, transaction_id, message_id, record_code, sub_record_code, str(quota_definition_sid))
