...
class duty(object):
	def __init__(self, commodity_code, measure_type_id, duty_expression_id,
	...
	quota_order_number_id, geographical_area_id, validity_start_date, validity_end_date, reduction_indicator, is_siv):
		self.commodity_code                  	= mstr(commodity_code)
		self.measure_type_id                 	= mstr(measure_type_id)
		self.duty_expression_id              	= mstr(duty_expression_id)
