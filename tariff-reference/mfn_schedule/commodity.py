...
class commodity(object):
	...
	def format_description(self):
		...
		self.description = self.description.replace(" <br>", "<br>")
		self.description = self.description.replace("<p/>", "<br>")
		self.description = self.description.replace("<br />", "<br>")
		self.description = self.description.replace("<br/>", "<br>")
		for i in range(1, 5):
			self.description = self.description.replace("<br><br>", "<br>")

		if self.description[-4:] == "<br>":
			self.description = self.description[:-4]

		#self.description = self.description + " "

		self.description = self.description.replace("<br>", "</w:t></w:r><w:r><w:br/><w:t>")
		self.description = self.description.replace("<br />", "</w:t></w:r><w:r><w:br/><w:t>")
		self.description = self.description.replace("<br/>", "</w:t></w:r><w:r><w:br/><w:t>")
		
		self.description = self.description.replace("<sup>", '</w:t></w:r><w:r><w:rPr><w:vertAlign w:val="superscript"/></w:rPr><w:t xml:space="preserve">')
		self.description = self.description.replace("</sup>", '</w:t></w:r><w:r><w:t xml:space="preserve">')

		self.description = self.description.replace("<sub>", '</w:t></w:r><w:r><w:rPr><w:vertAlign w:val="subscript"/></w:rPr><w:t xml:space="preserve">')
		self.description = self.description.replace("</sub>", '</w:t></w:r><w:r><w:t xml:space="preserve">')
		...
		self.description = re.sub("arcases", "arcasses", self.description, flags=re.MULTILINE)


		if (self.indents < 1): # Make it bold
