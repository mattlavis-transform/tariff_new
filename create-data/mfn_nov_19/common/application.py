...
class application(object):
    def __init__(self):
        ...
        self.fname_mfn_csv = os.path.join(self.SOURCE_DIR, "mfns_source_data.csv")
        ...
        for loop1 in range(0, list_count):
            ...
            if g1.measure_type_id != "":
                for loop2 in range(loop1 + 1, list_count):
                    g2 = self.goods_nomenclature_list[loop2]
                    if g2.parent_goods_nomenclature_item_id == g1.goods_nomenclature_item_id and g2.parent_productline_suffix == g1.productline_suffix:
