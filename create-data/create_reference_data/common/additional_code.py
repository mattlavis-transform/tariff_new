...
class additional_code(object):
    ...
    def get_next_certificate_description_period_sid(self):
        self.certificate_description_period_sid = g.app.last_certificate_description_period_sid
    ...
    def writeXML(self, app):
        if not(self.same):
            ...
            if self.type == "update":
                ...
                app.message_id += 3
            g.app.last_certificate_description_period_sid += 1
