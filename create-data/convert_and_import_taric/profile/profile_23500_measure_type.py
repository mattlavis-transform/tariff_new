...
class profile_23500_measure_type(object):
	def import_xml(self, app, update_type, oMessage, transaction_id, message_id):
		...
		trade_movement_code					= app.get_value(oMessage, ".//oub:trade.movement.code", True)
		priority_code						= app.get_value(oMessage, ".//oub:priority.code", True)
		measure_component_applicable_code	= app.get_value(oMessage, ".//oub:measure.component.applicable.code", True)
		origin_dest_code					= app.get_value(oMessage, ".//oub:origin.dest.code", True)
		order_number_capture_code			= app.get_value(oMessage, ".//oub:order.number.capture.code", True)
		measure_explosion_level				= app.get_value(oMessage, ".//oub:measure.explosion.level", True)
