...
class quota_order_number_origin_exclusions(object):
	...
	def get_measures(self):
		sql = """select distinct measure_sid from measures where validity_start_date >= '2019-11-01'
	...
	def xml(self):
		...
		out += o.app.quota_order_number_origin_exclusions_XML
	...
	def measure_xml(self):
		template = o.app.measure_excluded_geographical_area_XML
