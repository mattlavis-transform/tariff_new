...
class goods_nomenclature(object):
    def __init__(self, goods_nomenclature_sid, goods_nomenclature_item_id, productline_suffix, description, force=False):
        ...
        if force is False:
            ...
            g.app.last_goods_nomenclature_description_period_sid += 1
            self.goods_nomenclature_description_period_sid = g.app.last_goods_nomenclature_description_period_sid
    ...
    def writeXML(self):
        out = g.app.update_goods_nomenclature_description_XML
        ...
        out = out.replace("[VALIDITY_START_DATE]", fn.mdate(g.app.critical_date_plus_one))
        ...
        out = out.replace("[MESSAGE_ID2]", str(g.app.message_id + 1))
        out = out.replace("[MESSAGE_ID3]", str(g.app.message_id + 2))
        out = out.replace("[RECORD_SEQUENCE_NUMBER1]", str(g.app.message_id))
        out = out.replace("[RECORD_SEQUENCE_NUMBER2]", str(g.app.message_id + 1))
        out = out.replace("[RECORD_SEQUENCE_NUMBER3]", str(g.app.message_id + 2))
